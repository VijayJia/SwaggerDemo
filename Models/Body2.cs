...
namespace SwaggerDemo.Models
{
    ...
    public partial class Body2 :  IEquatable<Body2>
    {
        ...
        public Body2(long? Id = default(long?), long? PetId = default(long?), int? Quantity = default(int?), DateTime? ShipDate = default(DateTime?), StatusEnum? Status = default(StatusEnum?), bool? Complete = false)
        {
            this.Id = Id;
            this.PetId = PetId;
