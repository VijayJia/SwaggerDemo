...
namespace SwaggerDemo.Models
{
    ...
    public partial class Body5 :  IEquatable<Body5>
    {
        ...
        public Body5(long? Id = default(long?), string Username = default(string), string FirstName = default(string), string LastName = default(string), string Email = default(string), string Password = default(string), string Phone = default(string), int? UserStatus = default(int?))
        {
            this.Id = Id;
