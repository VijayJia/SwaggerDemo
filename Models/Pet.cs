...
namespace SwaggerDemo.Models
{
    ...
    public partial class Pet :  IEquatable<Pet>
    {
        ...
        public Pet(long? Id = default(long?), PetCategory Category = default(PetCategory), string Name = default(string), List<string> PhotoUrls = default(List<string>), List<PetTags> Tags = default(List<PetTags>), StatusEnum? Status = default(StatusEnum?))
        {
