...
namespace SwaggerDemo.Models
{
    ...
    public partial class Body1 :  IEquatable<Body1>
    {
        ...
        public Body1(long? Id = default(long?), PetCategory Category = default(PetCategory), string Name = default(string), List<string> PhotoUrls = default(List<string>), List<PetTags> Tags = default(List<PetTags>), StatusEnum? Status = default(StatusEnum?))
        {
            ...
            if (PhotoUrls == null)
            {
                throw new InvalidDataException("PhotoUrls is a required property for Body1 and cannot be null");
            }
            else
            {
