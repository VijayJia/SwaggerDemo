...
namespace SwaggerDemo.Models
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>
    {
        ...
        public InlineResponse2001(long? Id = default(long?), PetTags Category = default(PetTags), string Name = default(string), List<string> PhotoUrls = default(List<string>), List<PetTags> Tags = default(List<PetTags>), StatusEnum? Status = default(StatusEnum?))
        {
            ...
            if (PhotoUrls == null)
            {
                throw new InvalidDataException("PhotoUrls is a required property for InlineResponse2001 and cannot be null");
            }
            else
            {
        ...
        public PetTags Category { get; set; }
        /// <summary>
        /// Gets or Sets Name
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((InlineResponse2001)obj);
        }
