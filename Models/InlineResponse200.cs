...
namespace SwaggerDemo.Models
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>
    {
        ...
        public InlineResponse200(long? Id = default(long?), PetTags Category = default(PetTags), string Name = default(string), List<string> PhotoUrls = default(List<string>), List<PetTags> Tags = default(List<PetTags>), StatusEnum? Status = default(StatusEnum?))
        {
            ...
            if (PhotoUrls == null)
            {
                throw new InvalidDataException("PhotoUrls is a required property for InlineResponse200 and cannot be null");
            }
            else
            {
